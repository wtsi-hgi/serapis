...
def gather_mdata(file_to_submit):
    ...
    if hasattr(file_to_submit, 'file_reference_genome_id') and getattr(file_to_submit, 'file_reference_genome_id') != None:
        ...
        irods_mdata_dict = convert_mdata.convert_file_mdata(file_to_submit, ref_genome, user_id)
    else:
        irods_mdata_dict = convert_mdata.convert_file_mdata(file_to_submit, sanger_user_id=user_id)
