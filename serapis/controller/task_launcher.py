...
#    def __init__(self):
#        self.task_launcher = TaskLauncherBAMFile()
#        
#    @staticmethod
#    def submit_initial_tasks(self, file_id, user_id, file_obj=None, as_serapis=True):
#        return super(BatchTasksLauncherVCFFile, self).submit_initial_tasks(file_id, user_id, file_obj, as_serapis)
#            
#    @staticmethod
#    def submit_list_of_tasks(self, list_of_tasks, file_id, user_id, file_obj=None, as_serapis=True):
#        return super(BatchTasksLauncherVCFFile, self).submit_list_of_tasks(list_of_tasks, file_id, user_id, file_obj, as_serapis)
        
        
        
#            
#task_launch_BAM = TaskLauncherBAMFile()
#task_launch_BAM.launch_calculate_md5_task(None, None, None, None, None)
##print "Task launch --", task_launch_BAM
#
#batch1 = BatchTasksLauncherBAMFile()
#print "Mother class - batch1 =  ", batch1
#print "INHERITED PROPERTY: -- batch1.task_launcher= ", batch1.task_launcher, " \n"
##print "INHERITED PROPERTY: -- batch1 ", batch_task_launch_BAM.task_launcher
##print "INHERITED PROPERTY: -- batch1 ", vars(batch_task_launch_BAM.task_launcher)
#
#
#batch2 = BatchTasksLauncherBAMFile()
#print "Mother class - batch2 = ", batch2
##print "INHERITED PROPERTY -- batch2: ", batch2.task_launcher
#print "INHERITED PROPERTY -- batch2.task_launcher = ", batch2.task_launcher, "\n"
# 
#print "HEX ID batch1 = ", hex(id(batch1))
#print "HEX ID batch2 = ", hex(id(batch2)), '\n'
#
#print "INHERITED PROPERTY -- batch1.task_launcher = ", batch1.task_launcher
#print "INHERITED PROPERTY -- batch2.task_launcher = ", batch2.task_launcher
#
...
# 
#
#print "Other instances: ", BatchTasksLauncherBAMFile().task_launcher
#print "Other instances: ", BatchTasksLauncherBAMFile().task_launcher
#print "Other instances: ", BatchTasksLauncherBAMFile().task_launcher
#print "Other instances: ", BatchTasksLauncherBAMFile().task_launcher
#print "Other instances: ", BatchTasksLauncherBAMFile().task_launcher
#
#batch1.submit_initial_tasks(None, None, None, None)
