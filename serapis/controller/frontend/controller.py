...
def create_submission(user_id, data):
    ...
    if '_is_uploaded_as_serapis' in submission_data:
        upld_as_serapis =  submission_data['_is_uploaded_as_serapis']
    ...
    if upld_as_serapis and constants.NOACCESS in verif_result.warning_dict:
        ...
        result.message = result.message + "Please give access to serapis user or resubmit your request with '_is_uploaded_as_serapis' : False."
