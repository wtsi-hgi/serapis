...
FILE_SUBMISSION_STATUS = ("SUCCESS", "FAILURE", "PENDING_ON_USER", "PENDING_ON_WORKER", "IN_PROGRESS", "READY_FOR_SUBMISSION", "SUBMITTED_TO_IRODS")
...
SUBMITTED_TO_IRODS = "SUBMITTED_TO_IRODS"
