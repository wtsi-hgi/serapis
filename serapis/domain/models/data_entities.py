...
class MetadataEntity(object):
    ...
    @staticmethod
    def build_from_identifier(identifier):
        identifier_type = identifiers.guess_identifier_type(identifier)
        return Sample(**{identifier_type: identifier})
...
class Study(MetadataEntity):
    ...
    def __init__(self, name, pi_list, faculty_sponsor=None, accession_number=None, study_type=None, title=None,
