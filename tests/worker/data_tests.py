...
class TestFunctions(unittest.TestCase):
    ...
    def test_get_file_replicas(self):
        ...
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
    ...
    def test_extract_resource_from_replica_list(self):
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/md5-check.out'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        resc_list = data_tests.FileTests.extract_resource_from_replica_list(replicas)
    ...
    def test_check_replicas_by_resource(self):
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/md5-check.out'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        result = data_tests.FileTests.check_replicas_by_resource(replicas)
        self.assertTrue(result)
        
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/same_resc_test.txt'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        self.assertRaises(exceptions.iRODSFileNotBackedupOnBothRescGrps, data_tests.FileTests.check_replicas_by_resource, replicas)
        
    def test_check_replicas_by_number(self):
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/md5-check.out'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        self.assertRaises(exceptions.iRODSFileTooManyReplicasException, data_tests.FileTests.check_replicas_by_number, replicas)
        
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/no_replica_test.txt'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        self.assertRaises(exceptions.iRODSFileMissingReplicaException, data_tests.FileTests.check_replicas_by_number, replicas)
        
    
    def test_check_replicas_are_paired(self):
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/md5-check.err'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        self.assertTrue(data_tests.FileTests.check_replicas_are_paired(replicas))
        
        irods_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/md5-check.out'
        replicas = data_tests.FileTests.get_file_replicas(irods_path)
        self.assertRaises(exceptions.iRODSReplicaNotPairedException, data_tests.FileTests.check_replicas_are_paired, replicas)
        
    
    def test_compare_fofn(self):
        result = data_tests.FileTests.compare_fofn_and_irods_coll('/nfs/users/nfs_i/ic4/Projects/serapis-web/helic/helic.list', '/humgen/projects/helic/20140310')
        self.assertTrue(result)
        ...
        result = data_tests.FileTests.compare_fofn_and_irods_coll(fofn, irods_coll)
        self.assertTrue(result)
    ...
    def test_compare_file_md5(self):
        irods_file_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/compare_meta_md5_with_calc.txt'
        self.assertRaises(exceptions.iRODSFileDifferentMD5sException, data_tests.FileTests.compare_file_md5, irods_file_path)
        
        
    def test_checksum_all_replicas(self):
        irods_file_path = '/humgen/projects/serapis_staging/md5-check.out'
        self.assertRaises(exceptions.iRODSFileDifferentMD5sException, data_tests.FileTests.checksum_all_replicas, irods_file_path)
    ...
    def test_get_tuples_from_imeta_output(self):
        ...
        irods_file_path = '/humgen/projects/serapis_staging/test-coll/unittest-data-checks/meta_tests2.txt'
        self.assertRaises(exceptions.iRODSFileMetadataNotStardardException, data_tests.FileTests.test_file_meta_irods, irods_file_path)
